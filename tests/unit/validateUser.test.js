...
describe('Date of Birth Validation', () => {
    it('should pass for the following valid data', () => {
        expect(() => user_1.createUserSchema.parse(validUser)).not.toThrow();
    });
    it('should fail for the unparsable date 45/12/2023', () => {
        expect(() => user_1.createUserSchema.parse({ ...validUser, "dob": '45/12/2023' })).toThrow();
    });
});
describe('Date of Birth Validation', () => {
    it('should pass for the following valid dates', () => {
        ...
        validDates.forEach((date) => {
            expect(() => user_1.createUserSchema.parse({ ...validUser, "dob": date, })).not.toThrow();
        });
    });
    it('should fail for invalid Dates', () => {
        ...
        invalidDates.forEach((date) => {
            expect(() => user_1.createUserSchema.parse({ ...validUser, "dob": date })).toThrow();
        });
    });
});
